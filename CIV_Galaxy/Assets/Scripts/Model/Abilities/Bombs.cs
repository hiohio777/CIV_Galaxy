...
public class Bombs : AttackerAbility
{
    ...
    protected override void Finall(IUnitAbility unit, ICivilization civilizationTarget)
    {
        ...
        // Урон по индустрии
        if (civilizationTarget.IndustryCiv.Points * 100f > civilizationTarget.CivData.Shields)
        {
            // Щиты пробиты
            ...
            float shields = damege / 100 * civilizationTarget.CivData.Shields;
            damege -= shields;
            ...
            if (civilizationTarget.IndustryCiv.Points * 100f < civilizationTarget.CivData.Shields)
                civilizationTarget.IndustryCiv.Points = civilizationTarget.CivData.Shields / 100f;
        }
    }
