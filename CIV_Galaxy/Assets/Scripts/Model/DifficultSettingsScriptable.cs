...
public class DifficultSettingsScriptable : ScriptableObject
{
    ...
    [SerializeField, Range(50, 100), Header("Время получения поинта")] private int scienceSecund = 0;
    [SerializeField, Range(50, 100), Header("Время сканирования")] private int scanerSecund = 0;
    [SerializeField, Range(0, 100), Header("Бонус к общему росту доминирования")] private int gdOverall = 0;
